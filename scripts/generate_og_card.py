...
d.text((88, 100), "IDENTITY ENGINEER  ·  ENTRA ID  ·  IAM / IGA", fill=green, font=kicker)
d.text((88, 170), "Samuel Kofi Agyei-Tuffour", fill=text, font=name)
d.text((88, 250), "Identity Engineer", fill=cyan, font=role)
d.text((88, 292), "Entra ID  ·  IAM / IGA  ·  lifecycle automation", fill=cyan, font=role)
...
d.text((88, 500), "Open to Identity / IAM engineering roles in the Netherlands", fill=green, font=meta)
